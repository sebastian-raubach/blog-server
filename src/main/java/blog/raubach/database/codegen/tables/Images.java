...
public class Images extends TableImpl<ImagesRecord> {
    ...
    private static final long serialVersionUID = 140121987;
     ...
     */
    public final TableField<ImagesRecord, Double> LATITUDE = createField("latitude", org.jooq.impl.SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>blog_db.images.longitude</code>.
     */
    public final TableField<ImagesRecord, Double> LONGITUDE = createField("longitude", org.jooq.impl.SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>blog_db.images.elevation</code>.
     */
    public final TableField<ImagesRecord, Double> ELEVATION = createField("elevation", org.jooq.impl.SQLDataType.DOUBLE, this, "");
    ...
    public Identity<ImagesRecord, Integer> getIdentity() {
        return Internal.createIdentity(blog.raubach.database.codegen.tables.Images.IMAGES, blog.raubach.database.codegen.tables.Images.IMAGES.ID);
    }
    ...
    public UniqueKey<ImagesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(blog.raubach.database.codegen.tables.Images.IMAGES, "KEY_images_PRIMARY", blog.raubach.database.codegen.tables.Images.IMAGES.ID);
    }
    ...
    public List<UniqueKey<ImagesRecord>> getKeys() {
        return Arrays.<UniqueKey<ImagesRecord>>asList(
              Internal.createUniqueKey(blog.raubach.database.codegen.tables.Images.IMAGES, "KEY_images_PRIMARY", blog.raubach.database.codegen.tables.Images.IMAGES.ID)
        );
    }
