...
import blog.raubach.database.codegen.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    private static final long serialVersionUID = 1491241572;

    /**
     * The reference instance of <code>blog_db.schema_version</code>
     */
    ...
    /**
     * The column <code>blog_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>blog_db.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>blog_db.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>blog_db.schema_version.installed_on</code>.
     */
    ...
    /**
     * The column <code>blog_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * The column <code>blog_db.schema_version.success</code>.
     */
    ...
    /**
     * Create a <code>blog_db.schema_version</code> table reference
     */
    ...
    /**
     * Create an aliased <code>blog_db.schema_version</code> table reference
     */
    ...
    public UniqueKey<SchemaVersionRecord> getPrimaryKey() {
        return Internal.createUniqueKey(blog.raubach.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", blog.raubach.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK);
    }
    ...
    public List<UniqueKey<SchemaVersionRecord>> getKeys() {
        return Arrays.<UniqueKey<SchemaVersionRecord>>asList(
              Internal.createUniqueKey(blog.raubach.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", blog.raubach.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK)
        );
    }
