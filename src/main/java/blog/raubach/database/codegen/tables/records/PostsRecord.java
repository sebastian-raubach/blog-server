...
public class PostsRecord extends UpdatableRecordImpl<PostsRecord> implements Record7<Integer, PostsType, String, String, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -209909229;
     ...
     */
    @Override
    public Row7<Integer, PostsType, String, String, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, PostsType, String, String, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public PostsRecord values(Integer value1, PostsType value2, String value3, String value4, Timestamp value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PostsRecord(Integer id, PostsType type, String title, String content, Timestamp endDate, Timestamp createdOn, Timestamp updatedOn) {
        super(Posts.POSTS);
