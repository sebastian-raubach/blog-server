...
public class PropertyWatcher
{
	...
	{
		throw new RuntimeException("Germinate failed to start: Non-optional property not set: '" + property + "'");
	}
	 ...
	 */
	public static void setInteger(String property, Integer value)
	{
		if (value != null)
	 ...
	 */
	public static void setFloat(String property, Float value)
	{
		if (value != null)
	 ...
	 */
	public static String get(String property, Object... parameters)
	{
		String value = get(property);
